      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'MY_Docs')
              : MYDocsWidget(),
        ),
        FFRoute(
          name: 'MY_Budgets',
        ...
        FFRoute(
          name: 'Profile17SocialApp',
          path: '/profile17SocialApp',
          builder: (context, params) => Profile17SocialAppWidget(),
        ),
        FFRoute(
          name: 'MY_DocsCopy',
          path: '/mYDocsCopy',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'MY_DocsCopy')
              : MYDocsCopyWidget(),
        ),
        FFRoute(
          name: 'List02Products',
